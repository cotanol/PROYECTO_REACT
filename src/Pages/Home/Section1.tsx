    ...
    <>
      ...
      <div className="bg-black">
        <div className="md:px-10 md:py-8 container mx-auto flex py-4 flex-wrap justify-center md:justify-between items-center gap-4">
          <img className="md:w-[12%]" src="./public/versace-logo.svg" />
          <img className="md:w-[12%]" src="./public/gucci-logo.svg" />
          <img className="md:w-[8%]" src="./public/zara-logo.svg" />
          <img className="md:w-[12%]" src="./public/prada-logo.svg" />
          <img className="md:w-[12%]" src="./public/calvinklein-logo.svg" />
        </div>
      </div>
    </>
  );
